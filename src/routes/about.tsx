...
function AboutPage() {
  const about = useSiteContent("about", {
    title: "Affordable homes, built on trust",
    body: "Budget Homes was founded with a simple belief: home ownership should be within everyone's reach. We connect first-time buyers and seasoned investors with quality residences across Nalasopara, Boisar, Palghar, and Umroli — at prices that make sense.\n\nFrom the first site visit to handover and beyond, our team handles property selection, legal verification, financing guidance, and long-term management. We're not just brokers — we're partners in your property journey.",
  });
  return (
    <div className="bg-surface text-on-surface min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-section-gap">
        <div className="max-w-3xl">
          ...
          <h1 className="text-headline-xl font-headline-xl text-primary mb-6">{about.title}</h1>
          <p className="text-body-lg text-on-surface-variant mb-10 whitespace-pre-line">{about.body}</p>
